...
#------------------------------------------------------------------------------
# Convert Mesh to only traingles format
#------------------------------------------------------------------------------

def triangle_conversion(filename, ofilename):
# filename = "goal_cue.obj"
...
#------------------------------------------------------------------------------
# interpolate the position data, make it regularly sampled 
#------------------------------------------------------------------------------
def interp_pos(t, pos, N=1):
    ...
    x, y = interp1d(t, pos[:,0]), interp1d(t, pos[:,1])
